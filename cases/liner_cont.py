...
# sleep(2)
# # tab_loc=driver.find_element(By.ID,"data")
# # tr_loc=tab_loc.find_element(By.CSS_SELECTOR,"td:nth-child(1)")
# # for tds in tr_loc:
# #     td=tds.find_element_by_tag_name("a")
# #     tst.append(td)
...
#                     "#form1 > table > tbody > tr:nth-child(1) > td:nth-child(10) > a:nth-child(1)").click()
# sleep(5)
# driver.quit()
# driver = webdriver.Chrome()
# driver.get("http://192.168.1.211/crm/index.php?m=user&a=login")
...
# # 点击编辑按钮
# driver.find_element(By.CSS_SELECTOR,
#                     "#form1 > table > tbody > tr:nth-child(1) > td:nth-child(10) > a:nth-child(2)").click()
# sleep(2)
# # 修改负责人
...
loc=driver.find_element_by_id("field")
select=Select(loc)
